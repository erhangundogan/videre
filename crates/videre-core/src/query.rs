...
/// The rows a selection narrowed to, plus their distances when a place was
/// given.
///
/// Kept after `Filters` was retired in favour of
/// `videre_core::selection::RowSelection`: this is the shape `search`
/// consumes, and one name for one thing is better than two.
